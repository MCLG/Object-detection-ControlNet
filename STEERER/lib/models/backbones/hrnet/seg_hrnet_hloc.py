...
class HighResolutionNet(nn.Module):
    ...
    def forward(self, x, which_branch=None):
        ...
        grad_track = x.requires_grad
        
        #with torch.set_grad_enabled(grad_track and torch.is_grad_enabled()) :
...
class MocHRBackbone(object):
    ...
    def __call__(self):
        ...
        from STEERER.lib.models.backbones.hrnet.hrnet_config import MODEL_CONFIGS

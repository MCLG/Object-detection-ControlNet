...
from STEERER.lib.utils.utils import *
from STEERER.lib.utils.points_from_den import local_maximum_points
from STEERER.lib.eval.eval_loc_count import eval_loc_MLE_point, eval_loc_F1_boxes
...
def test_cc(config, test_dataset, testloader, model
    ...
    model.eval()
    save_count_txt = ''
    print(f'[current location : "/home/luk02485/development/ControlNet/STEERER/lib/core/cc_function.py:314:" ] device is chosen as cuda.current_device {torch.cuda.current_device()}')
...
def test_loc(config, test_dataset, testloader, model
    ...
    model.eval()
    print(f'[current location : "/home/luk02485/development/ControlNet/STEERER/lib/core/cc_function.py:378:" ] device is chosen as cuda.current_device {torch.cuda.current_device()}')
    device = torch.cuda.current_device()
    cnt_errors = {'mae': AverageMeter(), 'mse': AverageMeter(), 'nae': AverageMeter()}
    num_classes = 6
    max_dist_thresh = 100

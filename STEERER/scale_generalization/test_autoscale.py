...
def test_cc(config, test_dataset, testloader, model,rate_model,gaussian
    ...
    model.eval()
    save_count_txt = ''
    print(f'[current location : "/home/luk02485/development/ControlNet/STEERER/scale_generalization/test_autoscale.py:183:"] setting device via cuda.current_device() = {torch.cuda.current_device()}')

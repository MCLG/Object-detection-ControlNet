...
def test_cc(config, test_dataset, testloader, model
    ...
    model.eval()
    save_count_txt = ''
    print(f'[current location : "/home/luk02485/development/ControlNet/STEERER/scale_generalization/test_scale_level.py:157:"] setting device via cuda.current_device() = {torch.cuda.current_device()}')
